# convergio-observatory

[![CI](https://github.com/Roberdan/convergio-observatory/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-observatory/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-observatory/blob/main/LICENSE)
...
```mermaid
graph LR
    CRATE[convergio-observatory] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
